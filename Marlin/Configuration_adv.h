...
#define DUAL_X_CARRIAGE
  ...
  #define TOOLCHANGE_PARK_ZLIFT   0.4      // the distance to raise Z axis when parking an extrude
  #define TOOLCHANGE_UNPARK_ZLIFT 0.4        // the distance to raise Z axis when unparking an extruder
