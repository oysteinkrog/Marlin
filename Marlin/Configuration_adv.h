...
#define DUAL_X_CARRIAGE
  ...
  #define TOOLCHANGE_PARK_ZLIFT   (0.04*10)// the distance to raise Z axis when parking an extruder
...
#define HOMING_BUMP_DIVISOR {80, 10, 8}  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
